...
class CombinedModel(nn.Module):
    ...
    def forward(self, input1, input2):
        ...
        head_output = nn.Linear(fusion_output.shape[1], self.config['Models']['mlp_num_classes']).to(self.device)(fusion_output).to(self.device)
...
criterion = CCA_objective(256, criterion=nn.BCEWithLogitsLoss())
