...
class CombinedModel(nn.Module):
    ...
    def forward(self, input1, input2):
        ...
        fusion_output = TensorFusion()([image_output,text_output]).to(self.device)
...
os.chdir(home_path)
train_metrics.to_csv(home_path + "/results/metrics/" + str(idx) + "/hatefulmemes_tensor_fusion_config_" + str(idx) + ".csv",index=False)
