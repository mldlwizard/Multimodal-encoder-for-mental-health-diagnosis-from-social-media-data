...
def unimodal_img(configuration, trial=None):
...
# os.chdir(home_path)
# train_metrics.to_csv(home_path + "/results/metrics/" + str(idx) + "/hatefulmemes_unimodal_img_config_" + str(idx) + ".csv",index=False)
