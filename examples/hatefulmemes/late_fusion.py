...
def late_fusion(configuration,trial=None):
...
# os.chdir(home_path)
# train_metrics.to_csv(home_path + "/results/metrics/" + str(idx) + "/hatefulmemes_late_fusion_config_" + str(idx) + ".csv",index=False)
